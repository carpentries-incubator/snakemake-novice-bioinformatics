...
> > ## Solution
> >
> > A sample solution to this exercise [is available here](../code/assembly_with_conda.Snakefile), along with a
> > suitable [Conda environment spec](../code/assembly_conda_env.yaml). However, there is
